const About = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-navy mb-8 font-luminari">Our Story</h1>
      <div className="prose max-w-none">
        <p className="text-lg text-gray-700 mb-6 font-luminari">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
          <div className="bg-light-blue p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-navy mb-4 font-luminari">Our Mission</h2>
            <p className="text-gray-700 font-luminari">
          ...
          <div className="bg-light-blue p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-navy mb-4 font-luminari">Our Values</h2>
            <p className="text-gray-700 font-luminari">
